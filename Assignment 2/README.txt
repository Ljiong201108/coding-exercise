...
(number of ints as unit, a page of 4096 bytes has 1024 ints)
...
The size of the shared memory and the queue can be changed, but this condition should holds: 5 * QUEUE_SIZE + 2 <= total number of ints
